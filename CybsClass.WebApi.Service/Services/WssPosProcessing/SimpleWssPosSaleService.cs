...
{
    public static class SimpleWssPosSaleService
    {
        public static async Task<string> SimpleCallForPosSale()
        {
            ...
            try
            {
                ...
                wssPosResponse = await SimpleWssPosTransaction.WssCybsTransaction(jsonString);
