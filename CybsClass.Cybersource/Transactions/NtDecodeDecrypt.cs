...
using System.Text;
using CybsClass.Cybersource.Models.Exception;

namespace CybsClass.Cybersource.Transactions
{
    public class NtDecodeDecrypt
    {

        public NtDecodeDecrypt()
        {
        ...
        private static bool ValidateTokenSignature(RSAParameters publicKey, string signedFields, string signature)
        {
            ...
            using (RSACryptoServiceProvider rsa = new())
            {
                ...
                var logger = loggerFactory.CreateLogger<NtDecodeDecrypt>();
                ...
                {
                    logger.LogError($"FlexInternalException : Error validating signature\n{e.Message}");
