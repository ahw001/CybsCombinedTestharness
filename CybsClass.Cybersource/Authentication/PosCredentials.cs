    ...
    public static class PosCredentials
    {
        ...
        public static string GenerateJWT(string request, string method, bool boardingAPI)
        {
            ...
            try
            {
                ...
                Console.WriteLine("Path to file: " + Path.GetFullPath(Path.Combine(AppContext.BaseDirectory, "Resource", "certs")));


                X509Certificate2 x5Cert = new X509Certificate2(Path.Combine(AppContext.BaseDirectory, "Resource", "certs", P12JwtCredential!), KeyPass, X509KeyStorageFlags.EphemeralKeySet);
